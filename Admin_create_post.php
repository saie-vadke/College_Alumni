...
if (isset($_REQUEST['btn_submit']))
{
	...
	{
		$insertq="INSERT INTO post VALUES(NULL,'".$_REQUEST['post_title']."','".$_REQUEST['post_disc']."','".$cdate."')";
...
<div class="row">
  <div class="col-lg-10 " style="margin-top: 20px; margin-left: 50px; border: 1px #CCCCCC solid;">
    <h1> Create Post </h1>
     <h3>
    <?php if (isset($msg))
	{
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
          <thead>
           ...
           <form action="Admin_create_post.php" method="post">
            <?php
$check_post=executeQuery("SELECT * FROM post ORDER BY sr_no DESC");
$sr_no1=0;
