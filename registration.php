...

{
	...
	else
	{
			...
			$insertq="INSERT INTO registration VALUES(NULL,'".$_REQUEST['std_fname']."','".$_REQUEST['std_lname']."', '".$_REQUEST['std_email']."','".$_REQUEST['std_mobile']."','".$_REQUEST['std_dob']."','".$_REQUEST['std_course']."','".$_REQUEST['std_gender']."','".$_REQUEST['std_address']."','".$_REQUEST['std_city']."','".$_REQUEST['std_type']."','".$_REQUEST['std_password']."','".$_REQUEST['std_password']."','".$_REQUEST['std_question']."','".$_REQUEST['std_ans']."')";
   ...
   if (isset($smsg))
	  ...
	  ?>
    					<div class="alert alert-success alert-dismissable">
								...
								?>
                                <br> <a href="index.php"> Click Here </a> to Login Page... <br>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <form role="form" data-toggle="validator" action="registration.php" method="post">
                ...
                <div class="form-group">
                  <label>Address:</label>
                  <input type="text" name="std_address"  class="form-control" rows="3"></textarea>
                </div>
                <div class="form-group">
                  <label>City:</label>
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="std_password" class="form-control" id="inputSuccess">
                </div>
                 <div class="form-group">
